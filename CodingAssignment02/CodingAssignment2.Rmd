...
Based on the results above, we can see that BMI and WinterSprings test statistically significant. This means that we have sufficient evidence in that the slopes of the coefficients are different than zero.
