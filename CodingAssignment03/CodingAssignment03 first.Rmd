...
insurance <- read_excel("C:/Users/phupw/OneDrive/Desktop/Eco 6416/SEC0126GROUP06/Data/insurance_0126_Group6.xlsx")
...
index <- sample(seq_len(nrow(insurance1)), size = 3)

train <- insurance1[-index,]
test <- insurance1[index,]
summary(train)
summary(test)
```
